...
$logPath = "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\AppActionProcessor.log"
...
function Get-LogData {
    ...
    if (Test-Path $logPath) {
        ...
        $matches = [regex]::Matches($fileText, $pattern, [System.Text.RegularExpressions.RegexOptions]::Singleline)
